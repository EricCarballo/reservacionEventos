...
public class frmEditarRess extends javax.swing.JFrame {

    int xMouse, yMouse;

    public frmEditarRess() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbEvento.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        ...
        imagenCargada.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(cmbEvento, 0, 120, Short.MAX_VALUE)
        ...
        txtFecha.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/mesaFondoo.png"))); // NOI18N
        txtFecha.setText("jLabel4");
        jPanel1.add(txtFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        jPanel1.add(txtEvento, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 70, 50, 10));
        jPanel1.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 230, 40, 20));
    ...
    private void btnReservarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReservarActionPerformed
        ...
        String idReservacionTxt = txtId.getText();
        int id = Integer.parseInt(idReservacionTxt);
        int idTipo = Integer.parseInt(tipoReservacion);
        String nombre = txtCliente.getText();
        String fecha = txtFecha.getText();

        ReservacionControlador RC = new ReservacionControlador();
        TblReservacion reseracionEditada = new TblReservacion(id, idTipo, nombre, fecha, true);
        RC.Editar(reseracionEditada);
        int i = JOptionPane.showConfirmDialog(null, "Editado Correctamente, ¿Deseas Editar Otro?", "Editar Reservación", JOptionPane.INFORMATION_MESSAGE);
        if (i != 1) {
            frmConsultarRes frm = new frmConsultarRes();
            frm.setVisible(true);
            this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEditarRess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmEditarRess().setVisible(true);
            }
        });
    }
