...
public class FrmCrearEmpleados extends javax.swing.JFrame {

    int xMouse, yMouse;

    public FrmCrearEmpleados() {
        initComponents();
    ...
    private void btnCrearEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearEmpleadoActionPerformed
        ...
        try {
            ...
            if (vacio.isEmpty()) {
                ...
                TblEmpleados empleadoEditado = new TblEmpleados(null, nombre, sueldo, edad, tel, direccion, usuario, contraseña, imgByte, activo);
                EmpleadoControlador EC = new EmpleadoControlador();
                EC.Editar(empleadoEditado);
                JOptionPane.showMessageDialog(null, "Empleado Creado", "Crear Empleado", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void img(){
        ImageIcon defaultIcon = new ImageIcon(getClass().getResource("/img/user.jpg"));
        Image imgDefault = defaultIcon.getImage().getScaledInstance(125, 125, 0);
        imgEmpleados.setIcon(new ImageIcon(imgDefault));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCrearEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCrearEmpleados().setVisible(true);
            }
        });
    }
